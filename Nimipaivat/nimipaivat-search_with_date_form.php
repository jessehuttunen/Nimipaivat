<div class="cent_left mini_top_margin">
  <label class="cent_left  " for="country">Hae päivällä ja maalla:</label>
  <form action="" method="GET" class='flexing'>
    <input type="date" id="start" class="nameday_search_bar thin_border white_background" name="dateselect"
      value="<?php echo $selected_date;?>">
    <select name="country" id="country2" class="white_background mid_button_margin" value=language_code>
